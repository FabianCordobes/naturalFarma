...
export default function StockForm() {
	...
	const productHandler = (event) => {
		...
		if (categories.length === 0) {
			window.alert('No existen categorias, por favor cree una !');
		}
		if (form.category === '') {
			setMenuProduct(false);
			window.alert('Seleccione una categoria por favor !');
		} else {
				...
				<form className={style.form1}>
					...
					<div>
						...
						<input
							...
							name="description"
							onChange={changeHandler}
							value={saveCategory.description}
							disabled={createProduct}
						/>
						<button
							onClick={submitHandlerCategory}
							disabled={createProduct}>
							Agregar
						</button>
					</div>
					<div>
						...
						<button
							onClick={submitHandlerDeleteCategory}
							disabled={createProduct}>
							Eliminar
						</button>
					</div>
					...
					<form
						...
						<div className={style.buttonbutton}>
							<button
								...
								className={style.buttonFacherito}>
