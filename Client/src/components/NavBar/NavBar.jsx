		...
		<nav className={style.navBar}>
			...
			<div className={style.rightSide}>
				...
				<div className={style.iconsContainer}>
					<Link to={'/favorites'} className={style.userIcon}>
						<FontAwesomeIcon icon={faHeart}  />
					</Link>
					<Link to={'/cart'} className={style.userIcon}>
						<FontAwesomeIcon icon={faShoppingCart}  />
					</Link>
					<Link onClick={() => showMenuDisplay()} className={style.userIcon}>
				...
				</div>
				{
					<div className={`${style.sideMenu} ${showMenu ? style.active : ''}`}>
						...
						{showUserMenu ? (
							...
							<button className={style.item} onClick={() => { handleSignOut()}}>Cerrar sesión</button>
							</>
						) : (
							<>
